...
**Examples:**
- Student: `juan.delacruz@lpu.edu.ph` → Password: `juan.delacruz_student`
- Faculty: `maria.santos@lpu.edu.ph` → Password: `maria.santos_faculty`
- ICT Staff: `pedro.reyes@lpu.edu.ph` → Password: `pedro.reyes_ict`
- Admin: `admin@lpu.edu.ph` → Password: `admin_admin`
